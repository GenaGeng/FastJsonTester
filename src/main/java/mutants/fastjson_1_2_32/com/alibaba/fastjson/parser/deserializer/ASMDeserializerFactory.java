...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public com.alibaba.fastjson.parser.deserializer.ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, classNameType, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), null);
        ...
        return (com.alibaba.fastjson.parser.deserializer.ObjectDeserializer) instance;
    }
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitTypeInsn(CHECKCAST, type(com.alibaba.fastjson.parser.deserializer.EnumDeserializer.class)); // cast
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "scanInt", "(C)I");
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "scanEnum",
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitMethodInsn(INVOKESTATIC, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class),
                                       "parseArray",
                                       "(Ljava/util/Collection;" //
                                                     + desc(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class) //
                                                     + "L" + DefaultJSONParser + ";" //
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "getFieldType",
                ...
                mw.visitMethodInsn(INVOKESPECIAL, //
                                   type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), //
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                _getFieldDeser(context, mw, fieldInfo);
                mw.visitMethodInsn(INVOKEVIRTUAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "scanEnum"
                        , "(L" + JSONLexerBase + ";[C" + desc(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class) + ")Ljava/lang/Enum;");
                mw.visitTypeInsn(CHECKCAST, type(fieldClass)); // cast
                mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
...
//                mw.visitLabel(enumNull_);
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class),
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ILOAD, 4);
        mw.visitMethodInsn(INVOKESPECIAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), //
                           "deserialze", //
                           "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "clazz", "Ljava/lang/Class;");
            mw.visitMethodInsn(INVOKESPECIAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "createInstance",
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEINTERFACE, type(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class), "deserialze",
        ...
        _getCollectionFieldItemDeser(context, mw, fieldInfo, itemType);
        if (isPrimitive) {
            mw.visitMethodInsn(INVOKEINTERFACE, type(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class), "getFastMatchToken", "()I");
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, type(ParserConfig.class), "getDeserializer",
                           "(Ljava/lang/reflect/Type;)" + desc(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.name);
        mw.visitMethodInsn(INVOKEVIRTUAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "getFieldDeserializer",
                           "(Ljava/lang/String;)" + desc(com.alibaba.fastjson.parser.deserializer.FieldDeserializer.class));
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            mw.visitInsn(DUP);
            mw.visitTypeInsn(INSTANCEOF, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class));
            mw.visitJumpInsn(IFEQ, instanceOfElse_);
            
            mw.visitTypeInsn(CHECKCAST, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class)); // cast
            mw.visitVarInsn(ALOAD, 1);
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, type(com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer.class), "deserialze",
                               "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;I)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, type(fieldClass)); // cast
            mw.visitVarInsn(ASTORE, context.var(fieldInfo.name + "_asm"));
    ...
    private void _getFieldDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Label notNull_ = new Label();
        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, context.className, fieldInfo.name + "_asm_deser__", desc(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class));
        mw.visitJumpInsn(IFNONNULL, notNull_);
        ...
        mw.visitFieldInsn(PUTFIELD, context.className, fieldInfo.name + "_asm_deser__", desc(com.alibaba.fastjson.parser.deserializer.ObjectDeserializer.class));
