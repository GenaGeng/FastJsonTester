...
public class FastJsonpHttpMessageConverter4 extends AbstractGenericHttpMessageConverter<Object> {
    ...
    protected void writeInternal(Object obj, Type type, HttpOutputMessage outputMessage) throws IOException,
        ...
        Object value = obj;
        if (obj instanceof com.alibaba.fastjson.support.spring.MappingFastJsonValue) {
            com.alibaba.fastjson.support.spring.MappingFastJsonValue container = (com.alibaba.fastjson.support.spring.MappingFastJsonValue) obj;
    ...
    protected int writePrefix(ByteArrayOutputStream out, Object object) throws IOException {
        String jsonpFunction = (object instanceof com.alibaba.fastjson.support.spring.MappingFastJsonValue ? ((com.alibaba.fastjson.support.spring.MappingFastJsonValue) object)
    ...
    protected int writeSuffix(ByteArrayOutputStream out, Object object) throws IOException {
        String jsonpFunction = (object instanceof com.alibaba.fastjson.support.spring.MappingFastJsonValue ? ((MappingFastJsonValue) object)
                .getJsonpFunction() : null);
        int length = 0;
        if (jsonpFunction != null) {
