package mutants.fastjson_1_2_32.com.alibaba.fastjson.support.spring;
...
public class FastJsonpResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        com.alibaba.fastjson.support.spring.MappingFastJsonValue container = getOrCreateContainer(body);
        beforeBodyWriteInternal(container, selectedContentType, returnType, request, response);
        return container;
    }

    /**
     * Wrap the body in a {@link com.alibaba.fastjson.support.spring.MappingFastJsonValue} value container (for providing
     * additional serialization instructions) or simply cast it if already wrapped.
     */
    protected com.alibaba.fastjson.support.spring.MappingFastJsonValue getOrCreateContainer(Object body) {
        return (body instanceof com.alibaba.fastjson.support.spring.MappingFastJsonValue ? (com.alibaba.fastjson.support.spring.MappingFastJsonValue) body : new com.alibaba.fastjson.support.spring.MappingFastJsonValue(body));
    }
