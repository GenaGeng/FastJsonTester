...
public class TypeUtils {
    ...
    public static byte[] castToBytes(Object value) {
        ...
        if (value instanceof String) {
            return com.alibaba.fastjson.util.IOUtils.decodeBase64((String) value);
        }
        throw new JSONException("can not cast to int, value : " + value);
    }
    ...
    private static List<com.alibaba.fastjson.util.FieldInfo> getFieldInfos(Class<?> clazz, boolean sorted, Map<String, com.alibaba.fastjson.util.FieldInfo> fieldInfoMap) {
        ...
        if (containsAll) {
            for (String item : orders) {
                com.alibaba.fastjson.util.FieldInfo fieldInfo = fieldInfoMap.get(item);
    ...
    private static void computeFields(
        ...
        for (Field field : fields) {
            ...
            if (!fieldInfoMap.containsKey(propertyName)) {
                com.alibaba.fastjson.util.FieldInfo fieldInfo = new com.alibaba.fastjson.util.FieldInfo(propertyName, null, field, clazz, null, ordinal, serialzeFeatures, parserFeatures,
