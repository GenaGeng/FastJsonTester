...
public class SerializeConfig {
    ...
    private final JavaBeanSerializer createASMSerializer(SerializeBeanInfo beanInfo) throws Exception {
        ...
        for (int i = 0; i < serializer.sortedGetters.length; ++i) {
            ...
            if (fieldClass.isEnum()) {
                ...
                if (!(fieldSer instanceof com.alibaba.fastjson.serializer.EnumSerializer)) {
    ...
    private final ObjectSerializer createJavaBeanSerializer(Class<?> clazz) {
	    ...
	    if (beanInfo.fields.length == 0 && Iterable.class.isAssignableFrom(clazz)) {
	        return com.alibaba.fastjson.serializer.MiscCodec.instance;
	    }
...
//		    asm = false;
		...
		put(Byte.class, com.alibaba.fastjson.serializer.IntegerCodec.instance);
		put(Short.class, com.alibaba.fastjson.serializer.IntegerCodec.instance);
		...
		put(Class.class, com.alibaba.fastjson.serializer.MiscCodec.instance);

		put(SimpleDateFormat.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		put(Currency.class, new com.alibaba.fastjson.serializer.MiscCodec());
		put(TimeZone.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		put(InetAddress.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		put(Inet4Address.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		put(Inet6Address.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		put(InetSocketAddress.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		put(File.class, com.alibaba.fastjson.serializer.MiscCodec.instance);
		...
		// atomic
		put(AtomicBoolean.class, com.alibaba.fastjson.serializer.AtomicCodec.instance);
		put(AtomicInteger.class, com.alibaba.fastjson.serializer.AtomicCodec.instance);
		put(AtomicLong.class, com.alibaba.fastjson.serializer.AtomicCodec.instance);
		put(AtomicReference.class, com.alibaba.fastjson.serializer.ReferenceCodec.instance);
		put(AtomicIntegerArray.class, com.alibaba.fastjson.serializer.AtomicCodec.instance);
		put(AtomicLongArray.class, AtomicCodec.instance);
		
		put(WeakReference.class, com.alibaba.fastjson.serializer.ReferenceCodec.instance);
	...
	public void addFilter(Class<?> clazz, SerializeFilter filter) {
	    ...
	    if (serializer instanceof SerializeFilterable) {
	        ...
	        if (this != SerializeConfig.globalInstance) {
	            if (filterable == com.alibaba.fastjson.serializer.MapSerializer.instance) {
	                com.alibaba.fastjson.serializer.MapSerializer newMapSer = new com.alibaba.fastjson.serializer.MapSerializer();
	...
	private ObjectSerializer getObjectWriter(Class<?> clazz, boolean create) {
        ...
        if (writer == null) {
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                put(clazz, com.alibaba.fastjson.serializer.DateCodec.instance);
            } else if (JSONAware.class.isAssignableFrom(clazz)) {
                put(clazz, JSONAwareSerializer.instance);
            } else if (JSONSerializable.class.isAssignableFrom(clazz)) {
                put(clazz, JSONSerializableSerializer.instance);
            } else if (JSONStreamAware.class.isAssignableFrom(clazz)) {
                put(clazz, com.alibaba.fastjson.serializer.MiscCodec.instance);
                ...
                if (className.startsWith("java.awt.") //
                    && com.alibaba.fastjson.serializer.AwtCodec.support(clazz) //
                ) {
                    // awt
                    if (!awtError) {
                        try {
                            put(Class.forName("java.awt.Color"), com.alibaba.fastjson.serializer.AwtCodec.instance);
                            put(Class.forName("java.awt.Font"), com.alibaba.fastjson.serializer.AwtCodec.instance);
                            put(Class.forName("java.awt.Point"), com.alibaba.fastjson.serializer.AwtCodec.instance);
                            put(Class.forName("java.awt.Rectangle"), com.alibaba.fastjson.serializer.AwtCodec.instance);
                        } catch (Throwable e) {
                            awtError = true;
                            // skip
                        }
                ...
                if ((!jdk8Error) //
                    ...
                    try {
                        ...
                        put(Class.forName("java.util.concurrent.atomic.LongAdder"), com.alibaba.fastjson.serializer.AdderSerializer.instance);
                ...
                if ((!oracleJdbcError) //
                    ...
                    try {
                        put(Class.forName("oracle.sql.DATE"), com.alibaba.fastjson.serializer.DateCodec.instance);
                ...
                if ((!guavaError) //
                    ...
                    try {
                        put(Class.forName("com.google.common.collect.HashMultimap"), //
                                com.alibaba.fastjson.serializer.GuavaCodec.instance);
