...
public class ThrowableDeserializer extends com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
        ...
        if (otherValues != null) {
            com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer exBeanDeser = null;
            ...
            if (exClass != null) {
                if (exClass == clazz) {
                    ...
                    if (exDeser instanceof com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer) {
