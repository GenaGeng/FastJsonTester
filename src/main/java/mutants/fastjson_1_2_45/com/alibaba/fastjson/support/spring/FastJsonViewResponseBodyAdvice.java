package mutants.fastjson_1_2_45.com.alibaba.fastjson.support.spring;
...
public class FastJsonViewResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public com.alibaba.fastjson.support.spring.FastJsonContainer beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class<? extends HttpMessageConverter<?>> selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        com.alibaba.fastjson.support.spring.FastJsonContainer container = getOrCreateContainer(body);
        beforeBodyWriteInternal(container, selectedContentType, returnType, request, response);
        return container;
    }

    private com.alibaba.fastjson.support.spring.FastJsonContainer getOrCreateContainer(Object body) {
        return (body instanceof com.alibaba.fastjson.support.spring.FastJsonContainer ? (com.alibaba.fastjson.support.spring.FastJsonContainer) body : new com.alibaba.fastjson.support.spring.FastJsonContainer(body));
    ...
    protected void beforeBodyWriteInternal(FastJsonContainer container, MediaType contentType,
        ...
        com.alibaba.fastjson.support.spring.PropertyPreFilters filters = new PropertyPreFilters();
