...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    protected com.alibaba.fastjson.serializer.BeanContext fieldContext;
    ...
    public void writePrefix(com.alibaba.fastjson.serializer.JSONSerializer serializer) throws IOException {
    ...
    public void writeValue(JSONSerializer serializer, Object propertyValue) throws Exception {
            ...
            if (fieldAnnotation != null && fieldAnnotation.serializeUsing() != Void.class) {
                ...
                if (format != null) {
                    if (runtimeFieldClass == double.class || runtimeFieldClass == Double.class) {
                        ...
                        fieldSerializer = new com.alibaba.fastjson.serializer.FloatCodec(format);
                    }
                }
        ...
        if (fieldInfo.unwrapped) {
            ...
            if (valueSerializer instanceof com.alibaba.fastjson.serializer.MapSerializer) {
                com.alibaba.fastjson.serializer.MapSerializer mapSerializer = (MapSerializer) valueSerializer;
