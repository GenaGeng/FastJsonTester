...
public class JavaBeanInfo {
    ...
    public JavaBeanInfo(Class<?> clazz, //
        ...
        if (orders != null) {
            LinkedHashMap<String, com.alibaba.fastjson.util.FieldInfo> map = new LinkedHashMap<String, com.alibaba.fastjson.util.FieldInfo>(fieldList.size());
            for (com.alibaba.fastjson.util.FieldInfo field : fields) {
        ...
        if (creatorConstructor != null) {
            ...
            if (!match) {
                boolean kotlin = com.alibaba.fastjson.util.TypeUtils.isKotlin(clazz);
                if (kotlin) {
                    this.creatorConstructorParameters = com.alibaba.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                    ...
                    this.creatorConstructorParameters = com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                }
            }
        }
    }
    ...
    public static JavaBeanInfo build(Class<?> clazz //
        ...
        JSONType jsonType = com.alibaba.fastjson.util.TypeUtils.getAnnotation(clazz,JSONType.class);
        if (jsonType != null) {
            ...
            if (creatorConstructor != null && !isInterfaceOrAbstract) { // 基于标记 JSONCreator 注解的构造方法
                ...
                if (types.length > 0) {
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        if (fieldAnnotation != null) {
                            field = com.alibaba.fastjson.util.TypeUtils.getField(clazz, fieldAnnotation.name(), declaredFields);
                        ...
                        if (fieldName == null || fieldName.length() == 0) {
                            if (lookupParameterNames == null) {
                                lookupParameterNames = com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(creatorConstructor);
                            }
                            fieldName = lookupParameterNames[i];
                        }

                        com.alibaba.fastjson.util.FieldInfo fieldInfo = new com.alibaba.fastjson.util.FieldInfo(fieldName, clazz, fieldClass, fieldType, field,
                ...
                if (kotlin && constructors.length > 0) {
                    paramNames = com.alibaba.fastjson.util.TypeUtils.getKoltinConstructorParameters(clazz);
                    creatorConstructor = com.alibaba.fastjson.util.TypeUtils.getKoltinConstructor(constructors);
                    com.alibaba.fastjson.util.TypeUtils.setAccessible(creatorConstructor);
                } else {
                    ...
                    for (Constructor constructor : constructors) {
                        ...
                        if (className.equals("org.springframework.security.web.authentication.WebAuthenticationDetails")) {
                            if (parameterTypes.length == 2 && parameterTypes[0] == String.class && parameterTypes[1] == String.class) {
                                ...
                                paramNames = com.alibaba.fastjson.util.ASMUtils.lookupParameterNames(constructor);
                                break;
                            }
                        }
                ...
                if (paramNames != null
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        Class<?> fieldClass = types[i];
                        Type fieldType = creatorConstructor.getGenericParameterTypes()[i];
                        Field field = com.alibaba.fastjson.util.TypeUtils.getField(clazz, paramName, declaredFields);
                        if (field != null) {
                            if (fieldAnnotation == null) {
                        ...
                        com.alibaba.fastjson.util.FieldInfo fieldInfo = new com.alibaba.fastjson.util.FieldInfo(paramName, clazz, fieldClass, fieldType, field,
                                ordinal, serialzeFeatures, parserFeatures);
                        add(fieldList, fieldInfo);
                    }
