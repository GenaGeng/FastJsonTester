...
public class JSONSerializer extends SerializeFilterable {
    ...
    protected IdentityHashMap<Object, com.alibaba.fastjson.serializer.SerialContext> references  = null;
    ...
    public void setContext(com.alibaba.fastjson.serializer.SerialContext context) {
        this.context = context;
    }

    public void setContext(com.alibaba.fastjson.serializer.SerialContext parent, Object object, Object fieldName, int features) {
        this.setContext(parent, object, fieldName, features, 0);
    }

    public void setContext(com.alibaba.fastjson.serializer.SerialContext parent, Object object, Object fieldName, int features, int fieldFeatures) {
        if (out.disableCircularReferenceDetect) {
            return;
        }

        this.context = new com.alibaba.fastjson.serializer.SerialContext(parent, object, fieldName, features, fieldFeatures);
        if (references == null) {
            references = new IdentityHashMap<Object, com.alibaba.fastjson.serializer.SerialContext>();
        }
    ...
    public boolean containsReference(Object value) {
        ...
        com.alibaba.fastjson.serializer.SerialContext refContext = references.get(value);
        if (refContext == null) {
            return false;
        }
    ...
    public void writeReference(Object object) {
        com.alibaba.fastjson.serializer.SerialContext context = this.context;
        ...
        com.alibaba.fastjson.serializer.SerialContext parentContext = context.parent;
