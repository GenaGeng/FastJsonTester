...
public class JavaBeanDeserializer implements com.alibaba.fastjson.parser.deserializer.ObjectDeserializer {
    ...
    private final Map<String, com.alibaba.fastjson.parser.deserializer.FieldDeserializer> alterNameFieldDeserializers;
    ...
    public JavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo){
        ...
        Map<String, com.alibaba.fastjson.parser.deserializer.FieldDeserializer> alterNameFieldDeserializers = null;
        sortedFieldDeserializers = new com.alibaba.fastjson.parser.deserializer.FieldDeserializer[beanInfo.sortedFields.length];
        for (int i = 0, size = beanInfo.sortedFields.length; i < size; ++i) {
            FieldInfo fieldInfo = beanInfo.sortedFields[i];
            com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = config.createFieldDeserializer(config, beanInfo, fieldInfo);

            sortedFieldDeserializers[i] = fieldDeserializer;

            for (String name : fieldInfo.alternateNames) {
                if (alterNameFieldDeserializers == null) {
                    alterNameFieldDeserializers = new HashMap<String, com.alibaba.fastjson.parser.deserializer.FieldDeserializer>();
                }
        ...
        fieldDeserializers = new com.alibaba.fastjson.parser.deserializer.FieldDeserializer[beanInfo.fields.length];
        for (int i = 0, size = beanInfo.fields.length; i < size; ++i) {
            FieldInfo fieldInfo = beanInfo.fields[i];
            com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = getFieldDeserializer(fieldInfo.name);
            fieldDeserializers[i] = fieldDeserializer;
        }
    }

    public com.alibaba.fastjson.parser.deserializer.FieldDeserializer getFieldDeserializer(String key) {
        return getFieldDeserializer(key, null);
    }

    public com.alibaba.fastjson.parser.deserializer.FieldDeserializer getFieldDeserializer(String key, int[] setFlags) {
        if (key == null) {
            return null;
        }
    ...
    public com.alibaba.fastjson.parser.deserializer.FieldDeserializer getFieldDeserializer(long hash) {
    ...
    public <T> T deserialzeArrayMapping(DefaultJSONParser parser, Type type, Object fieldName, Object object) {
        ...
        for (int i = 0, size = sortedFieldDeserializers.length; i < size; ++i) {
            ...
            com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = sortedFieldDeserializers[i];
            ...
            if (fieldClass == int.class) {
                ...
                if (ch == '\"' || ch == 'n') {
                    ...
                    com.alibaba.fastjson.parser.deserializer.EnumDeserializer enumDeser = (com.alibaba.fastjson.parser.deserializer.EnumDeserializer) ((DefaultFieldDeserializer) fieldDeser).getFieldValueDeserilizer(parser.getConfig());
    ...
    protected <T> T deserialze(DefaultJSONParser parser, // 
        ...
        try {
            ...
            for (int fieldIndex = 0;; fieldIndex++) {
                String key = null;
                com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = null;
                ...
                if (fieldDeser != null) {
                    ...
                    if (customDeserilizer && lexer.matchField(name_chars)) {
                        ...
                        if (lexer.matchStat > 0) {
                            ...
                            && parser.getConfig().getDeserializer(fieldClass) instanceof com.alibaba.fastjson.parser.deserializer.EnumDeserializer
                            && (feildAnnotation == null || feildAnnotation.deserializeUsing() == Void.class)
                            ) {
                        if (fieldDeser instanceof DefaultFieldDeserializer) {
                            com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeserilizer = ((DefaultFieldDeserializer) fieldDeser).fieldValueDeserilizer;
                ...
                if (!matchField) {
                    ...
                    if ((typeKey != null && typeKey.equals(key))
                        ...
                        if (lexer.token() == JSONToken.LITERAL_STRING) {
                            ...
                            com.alibaba.fastjson.parser.deserializer.ObjectDeserializer deserializer = getSeeAlso(config, this.beanInfo, typeName);
                            Class<?> userType = null;
                            ...
                            if (deserializer instanceof JavaBeanDeserializer) {
                                ...
                                if (typeKey != null) {
                                    com.alibaba.fastjson.parser.deserializer.FieldDeserializer typeKeyFieldDeser = javaBeanDeserializer.getFieldDeserializer(typeKey);
    ...
    protected Enum scanEnum(JSONLexerBase lexer, char[] name_chars, com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeserilizer) {
        com.alibaba.fastjson.parser.deserializer.EnumDeserializer enumDeserializer = null;
        if (fieldValueDeserilizer instanceof com.alibaba.fastjson.parser.deserializer.EnumDeserializer) {
    ...
    public boolean parseField(DefaultJSONParser parser, String key, Object object, Type objectType,
        ...
        if (fieldDeserializer == null
            ...
            if (deserOrField != null) {
                if (deserOrField instanceof com.alibaba.fastjson.parser.deserializer.FieldDeserializer) {
                    fieldDeserializer = ((com.alibaba.fastjson.parser.deserializer.FieldDeserializer) deserOrField);
                } else {
        ...
        if (fieldDeserializer == null) {
            ...
            for (com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser : this.sortedFieldDeserializers) {
                ...
                if (fieldInfo.unwrapped //
                    ...
                    if (fieldInfo.field != null) {
                        ...
                        com.alibaba.fastjson.parser.deserializer.ObjectDeserializer fieldValueDeser = defaultFieldDeserializer.getFieldValueDeserilizer(parser.getConfig());
                        if (fieldValueDeser instanceof JavaBeanDeserializer) {
                            ...
                            com.alibaba.fastjson.parser.deserializer.FieldDeserializer unwrappedFieldDeser = javaBeanFieldValueDeserializer.getFieldDeserializer(key);
                        ...
                        } else if (fieldValueDeser instanceof com.alibaba.fastjson.parser.deserializer.MapDeserializer) {
                            com.alibaba.fastjson.parser.deserializer.MapDeserializer javaBeanFieldValueDeserializer = (MapDeserializer) fieldValueDeser;
    ...
    public com.alibaba.fastjson.parser.deserializer.FieldDeserializer smartMatch(String key) {
        return smartMatch(key, null);
    }

    public com.alibaba.fastjson.parser.deserializer.FieldDeserializer smartMatch(String key, int[] setFlags) {
        if (key == null) {
            return null;
        }
        
        com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeserializer = getFieldDeserializer(key, setFlags);
    ...
    public Object createInstance(Map<String, Object> map, ParserConfig config) //
        ...
        if (beanInfo.creatorConstructor == null && beanInfo.factoryMethod == null) {
            ...
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                ...
                com.alibaba.fastjson.parser.deserializer.FieldDeserializer fieldDeser = smartMatch(key);
                if (fieldDeser == null) {
                    continue;
                }
    ...
    protected JavaBeanDeserializer getSeeAlso(ParserConfig config, JavaBeanInfo beanInfo, String typeName) {
        ...
        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
            com.alibaba.fastjson.parser.deserializer.ObjectDeserializer seeAlsoDeser = config.getDeserializer(seeAlsoClass);
