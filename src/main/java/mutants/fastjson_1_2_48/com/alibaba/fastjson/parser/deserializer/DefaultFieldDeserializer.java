...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public com.alibaba.fastjson.parser.deserializer.ObjectDeserializer getFieldValueDeserilizer(ParserConfig config) {
        if (fieldValueDeserilizer == null) {
            JSONField annotation = fieldInfo.getAnnotation();
            if (annotation != null && annotation.deserializeUsing() != Void.class) {
                Class<?> deserializeUsing = annotation.deserializeUsing();
                try {
                    fieldValueDeserilizer = (com.alibaba.fastjson.parser.deserializer.ObjectDeserializer) deserializeUsing.newInstance();
                } catch (Exception ex) {
    ...
    public void parseField(DefaultJSONParser parser, Object object, Type objectType, Map<String, Object> fieldValues) {
        ...
        if (fieldValueDeserilizer instanceof com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer && fieldInfo.parserFeatures != 0) {
            com.alibaba.fastjson.parser.deserializer.JavaBeanDeserializer javaBeanDeser = (JavaBeanDeserializer) fieldValueDeserilizer;
