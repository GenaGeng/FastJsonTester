...
public class JavaBeanSerializer extends SerializeFilterable implements ObjectSerializer {
    ...
    public void writeNoneASM(com.alibaba.fastjson.serializer.JSONSerializer serializer, //
                             Object object, //
                             Object fieldName, //
                             Type fieldType, //
                             int features) throws IOException {
    ...
    protected void write(com.alibaba.fastjson.serializer.JSONSerializer serializer, //
        ...
        try {
            ...
            if ((this.beanInfo.features & com.alibaba.fastjson.serializer.SerializerFeature.WriteClassName.mask) != 0
                ||(features & com.alibaba.fastjson.serializer.SerializerFeature.WriteClassName.mask) != 0
            ...
            for (int i = 0; i < getters.length; ++i) {
                ...
                if (propertyValue == null) {
                    ...
                    if (beanInfo.jsonType != null) {
                        serialzeFeatures |= com.alibaba.fastjson.serializer.SerializerFeature.of(beanInfo.jsonType.serialzeFeatures());
                    }
                    // beanInfo.jsonType
                    if (fieldClass == Boolean.class) {
                        int defaultMask = com.alibaba.fastjson.serializer.SerializerFeature.WriteNullBooleanAsFalse.mask;
                        final int mask = defaultMask | com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.mask;
                        ...
                        int defaultMask = com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.mask;
                        final int mask = defaultMask | com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.mask;
                        if ((!writeAsArray) && (serialzeFeatures & mask) == 0 && (out.features & mask) == 0) {
                            continue;
                        } else if ((serialzeFeatures & defaultMask) != 0 || (out.features & defaultMask) != 0) {
                        ...
                        int defaultMask = com.alibaba.fastjson.serializer.SerializerFeature.WriteNullNumberAsZero.mask;
                        final int mask = defaultMask | com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.mask;
                        if ((!writeAsArray) && (serialzeFeatures & mask) == 0 && (out.features & mask) == 0) {
                            continue;
                        } else if ((serialzeFeatures & defaultMask) != 0 || (out.features & defaultMask) != 0) {
                        ...
                        int defaultMask = com.alibaba.fastjson.serializer.SerializerFeature.WriteNullListAsEmpty.mask;
                        final int mask = defaultMask | com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.mask;
                        if ((!writeAsArray) && (serialzeFeatures & mask) == 0 && (out.features & mask) == 0) {
                            continue;
                        } else if ((serialzeFeatures & defaultMask) != 0 || (out.features & defaultMask) != 0) {
                    ...
                    } else if ((!writeAsArray) && (!fieldSerializer.writeNull) && !out.isEnabled(com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.mask)){
                        continue;
                    }
                }
                        ...
                        if (fieldClass == String.class && (fieldAnnotation == null || fieldAnnotation.serializeUsing() == Void.class)) {
                            if (propertyValue == null) {
                                if ((out.features & com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.mask) != 0
                                    || (fieldSerializer.features & com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.mask) != 0) {
                                    out.writeString("");
                                } else {
                                    out.writeNull();
                                }
                ...
                if (fieldInfo.unwrapped
                    ...
                    } else if (!serializer.isEnabled(com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue)){
    ...
    protected void writeClassName(com.alibaba.fastjson.serializer.JSONSerializer serializer, String typeKey, Object object) {
        if (typeKey == null) {
    ...
    public Object getFieldValue(Object object, String key, long keyHash, boolean throwFieldNotFoundException) {
        com.alibaba.fastjson.serializer.FieldSerializer fieldDeser = getFieldSerializer(keyHash);
        if (fieldDeser == null) {
    ...
    public com.alibaba.fastjson.serializer.FieldSerializer getFieldSerializer(long hash) {
