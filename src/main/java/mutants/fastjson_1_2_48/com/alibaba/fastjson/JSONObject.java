 ...
 */
public class JSONObject extends com.alibaba.fastjson.JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
    ...
    public com.alibaba.fastjson.JSONArray getJSONArray(String key) {
        ...
        if (value instanceof String) {
            return (com.alibaba.fastjson.JSONArray) JSON.parse((String) value);
        }
