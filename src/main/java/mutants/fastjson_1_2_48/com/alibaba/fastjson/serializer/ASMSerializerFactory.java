...
public class ASMSerializerFactory implements Opcodes {
    ...
    static final String            JSONSerializer           = type(com.alibaba.fastjson.serializer.JSONSerializer.class);
    static final String            ObjectSerializer         = type(com.alibaba.fastjson.serializer.ObjectSerializer.class);
    static final String            ObjectSerializer_desc    = "L" + ObjectSerializer + ";";
    static final String            SerializeWriter          = type(com.alibaba.fastjson.serializer.SerializeWriter.class);
    static final String            SerializeWriter_desc     = "L" + SerializeWriter + ";";
    static final String            JavaBeanSerializer       = type(com.alibaba.fastjson.serializer.JavaBeanSerializer.class);
    static final String            JavaBeanSerializer_desc  = "L" + type(com.alibaba.fastjson.serializer.JavaBeanSerializer.class) + ";";
    ...
    static class Context {
        ...
        private final com.alibaba.fastjson.serializer.SerializeBeanInfo beanInfo;
        ...
        public Context(FieldInfo[] getters, //
                       com.alibaba.fastjson.serializer.SerializeBeanInfo beanInfo, //
                       String className, //
                       boolean writeDirect, //
                       boolean nonContext){
    ...
    public com.alibaba.fastjson.serializer.JavaBeanSerializer createJavaBeanSerializer(com.alibaba.fastjson.serializer.SerializeBeanInfo beanInfo) throws Exception {
        ...
        for (FieldInfo fieldInfo : unsortedGetters) {
            if (fieldInfo.field == null //
                ...
                return new com.alibaba.fastjson.serializer.JavaBeanSerializer(beanInfo);
            }
        }
        ...
        MethodVisitor mw = new MethodWriter(cw, ACC_PUBLIC, "<init>", "(" + desc(com.alibaba.fastjson.serializer.SerializeBeanInfo.class) + ")V", null, null);
        mw.visitVarInsn(ALOAD, 0);
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKESPECIAL, JavaBeanSerializer, "<init>", "(" + desc(com.alibaba.fastjson.serializer.SerializeBeanInfo.class) + ")V");
...
//                || fieldInfo.fieldClass.isEnum() //
        ...
        if (jsonType != null) {
            for (com.alibaba.fastjson.serializer.SerializerFeature featrues : jsonType.serialzeFeatures()) {
                if (featrues == com.alibaba.fastjson.serializer.SerializerFeature.DisableCircularReferenceDetect) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            if (context.writeDirect && !nonContext) {
                ...
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.DisableCircularReferenceDetect.mask);
        ...
        return (com.alibaba.fastjson.serializer.JavaBeanSerializer) instance;
    }
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, FieldInfo[] getters,
        ...
        if (!context.writeDirect) {
            ...
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.PrettyFormat.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
            ...
            if (hasMethod) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.IgnoreErrorGetter.mask);
                mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
        ...
        if ((context.beanInfo.features & com.alibaba.fastjson.serializer.SerializerFeature.BeanToArray.mask) == 0) {
            ...
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.BeanToArray.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
        ...
        boolean writeClasName = (context.beanInfo.features & com.alibaba.fastjson.serializer.SerializerFeature.WriteClassName.mask) != 0;
    ...
    private void _filters(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        if (property.fieldTransient) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.SkipTransientField.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        if (property.field == null) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.IgnoreNonFieldGetter.mask);
            mw.visitMethodInsn(INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
    ...
    private void _writeObject(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
        ...
        if (Modifier.isPublic(fieldClass.getModifiers()) //
            ...
            boolean disableCircularReferenceDetect = (fieldInfo.serialzeFeatures & com.alibaba.fastjson.serializer.SerializerFeature.DisableCircularReferenceDetect.mask) != 0;
            boolean fieldBeanToArray = (fieldInfo.serialzeFeatures & com.alibaba.fastjson.serializer.SerializerFeature.BeanToArray.mask) != 0;
    ...
    private void _processValue(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, JavaBeanSerializer, "getBeanContext", "(I)" + desc(com.alibaba.fastjson.serializer.BeanContext.class));
        mw.visitVarInsn(ALOAD, Context.obj);
        mw.visitVarInsn(ALOAD, Context.fieldName);
    ...
    private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
        ...
        int features = 0;
        if (annotation != null) {
            features = com.alibaba.fastjson.serializer.SerializerFeature.of(annotation.serialzeFeatures());
        }
        JSONType jsonType = context.beanInfo.jsonType;
        if (jsonType != null) {
            features |= com.alibaba.fastjson.serializer.SerializerFeature.of(jsonType.serialzeFeatures());
        }

        int writeNullFeatures;
        if (propertyClass == String.class) {
            writeNullFeatures = com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.getMask();
        } else if (Number.class.isAssignableFrom(propertyClass)) {
            writeNullFeatures = com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | com.alibaba.fastjson.serializer.SerializerFeature.WriteNullNumberAsZero.getMask();
        } else if (Collection.class.isAssignableFrom(propertyClass)) {
            writeNullFeatures = com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | com.alibaba.fastjson.serializer.SerializerFeature.WriteNullListAsEmpty.getMask();
        } else if (Boolean.class == propertyClass) {
            writeNullFeatures = com.alibaba.fastjson.serializer.SerializerFeature.WriteMapNullValue.getMask()
                    | com.alibaba.fastjson.serializer.SerializerFeature.WriteNullBooleanAsFalse.getMask();
        } else {
            writeNullFeatures = com.alibaba.fastjson.serializer.SerializerFeature.WRITE_MAP_NULL_FEATURES;
        }
        ...
        if (propertyClass == String.class || propertyClass == Character.class) {
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.WriteNullStringAsEmpty.mask);
        } else if (Number.class.isAssignableFrom(propertyClass)) {
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.WriteNullNumberAsZero.mask);
        } else if (propertyClass == Boolean.class) {
            mw.visitLdcInsn(com.alibaba.fastjson.serializer.SerializerFeature.WriteNullBooleanAsFalse.mask);
